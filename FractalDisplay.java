...
public class FractalDisplay extends JPanel implements MouseListener, ActionListener, ChangeListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().getClass() == JRadioButton.class) {
			...
			//	shape = null;
				shape = new SierpinskiTriangle(getWidth()/2,0,getWidth(),0,getHeight(),getHeight(), Color.GREEN);
				break;
			case H_SHAPE:
				shape = new HShape(0,0,getWidth(),getHeight(), Color.YELLOW);
				break;
			case MY_SHAPE:
				shape = new MyShape(0,0,getWidth(), getHeight(), Color.RED);
			}
